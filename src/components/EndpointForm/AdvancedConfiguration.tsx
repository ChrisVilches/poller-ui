...
// TODO: This can be improved by also adding description, and storing this data in a localization system (along with the other texts.)
const ruleTokens = {
...
export const AdvancedConfiguration = ({
  ...
  <>
    <div>
      <input type="text" value={notificationMessage} onChange={(ev) => setNotificationMessage(ev.currentTarget.value)} />
      {
    ...
    <div>
      ...
      <ArgumentsForm values={args} names={ruleToArgumentNames[rule]} onChange={setArgs} types={ruleToArgumentTypes(rule)} />
    </div>
    ...
    <div>
      ...
      <input type="number" value={waitAfterNotificationMinutes} onChange={(ev) => setWaitAfterNotificationMinutes(+ev.currentTarget.value)} />
    </div>
  </>
)
